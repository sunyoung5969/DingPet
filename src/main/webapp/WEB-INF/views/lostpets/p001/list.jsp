                    ...
                    <c:forEach items = "${list}" var = "list">
	                    <div class="media service-box"> 
	                        ...
	                        <a href = '/lostpets/p001/view?board_id=<c:out value = "${list.board_id}"/>'>
	                            <h4 class="media-heading"><c:out value = "${list.title}" /></h4></a>
	                            <p><span class="tag">견종</span><span></span><c:out value = "${list.dog_breed}" /></p>
	                            <p><span class="tag">성별</span><span></span> <c:out value = "${list.dog_sex}" /></p>
	                            <p><span class="tag">발견장소</span><span></span><c:out value = "${list.found_location}" /></p>
	                        </div>
	                    </div>
                		 </c:forEach>
                </div>
