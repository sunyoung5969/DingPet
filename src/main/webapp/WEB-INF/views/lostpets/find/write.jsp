			...
			<div class="container">
				...
				<div class="row justify-content-center pt-5 pb-5" data-aos="fade-up">
					<div class="text-center heading-section">
						<h2 class="color_dark_blue narrow mb-2" style="font-family:GmarketSansBold;">반려견 찾기 등록</h2>
					</div>
				</div>
				...
				<div class="card-body pd40">
					<form id="lost_found_form" action="/lostpets/p001/write" method="post" enctype="multipart/form-data">
						...
						<div class="form-group row">
							<label
								class="col-md-4 col-form-label text-md-right color_blue lost_found_label">실종 날짜</label>
							<div class="col-md-6">
						...
						<div class="form-group row">
							<label
								class="col-md-4 col-form-label text-md-right color_blue lost_found_label">실종 장소</label>
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								...
								<div class = "uploadDiv">
									...
									<img id='front_view' style ="display:none; max-width:520px;" src = "">
								</div>
							</div>
						</div>
