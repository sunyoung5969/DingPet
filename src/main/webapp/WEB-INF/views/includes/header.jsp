...
<html lang="ko">
  ...
  <div class="site-wrap">
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    <li><a href="${pageContext.request.contextPath}/petsitting/p001/profilelist" class="nav-link">펫시터 목록</a></li>
                    <li><a href="${pageContext.request.contextPath}/petsitting/p002/reservationlist" class="nav-link">예약 현황</a></li>
                  </ul>  
                </li>
                <li class="has-children">
    ...
    <div class="tl_box">
		<div class="tl_config">
			<dl>
				<dd class="tit_config"><a href="https://my.musinsa.com/member/v1/mypage">알 림</a></dd>
				<dd class="dd_center"></dd>
				<dd class="btn_config"><a class="close" onclick="xClick()">X</a></dd>
			</dl>
		</div>
