	...
	<div class="main">
		...
		<section class="signup">
			...
			<div class="w-75 m-auto">
				...
				아이디<input type="text" id="member_id" name="member_id" maxlength="10" placeholder="Your ID"  /> 
				<input type="button" value="ID중복체크" id="btn_duplicate" onClick="fn_process()" />
				</div>
      
				<div class="form-group">
				비밀번호<input type="password" name="member_pwd" id="member_pwd" maxlength="10" placeholder="Your Password"  />
				</div>
				...
				비밀번호 확인<input type="password" name="re_member_pwd" id="re_member_pwd" placeholder="Repeat your Password"
                        ...
                        <div class="form-group">
                           이름<input type="text" name="member_name" id="member_name" maxlength="5" placeholder="Your Name"  />
                        </div>
      
                        <div class="form-group">
                           닉네임<input type="text" name="member_nickname" id="member_nickname" maxlength="5" placeholder="Your Nickname"  />
                        </div>
      
                        <div class="form-group">
                           이메일<input type="email" name="member_email" id="email" maxlength="40" placeholder="Your Email"  />
                        </div>
