			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						...
						<form method="POST" class="register-form" id="register-form"
							...
							<div class="form-group">
								<label for="new_id"><i class="zmdi zmdi-account material-icons-name"></i>
								</label> 
						...
						닉네임<input type="text" name="member_nickname" id="member_nickname"
					...
					<div class="signup-image">
						<figure>
							<img src="${pageContext.request.contextPath}/resources/images/sign/signup-image.png"
								alt="sing up image">
						</figure>
						<figure>
